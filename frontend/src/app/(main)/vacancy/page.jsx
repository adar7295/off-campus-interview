...
<div className='flex-wrap mt-0 py-0 h-full ml-10 mr-10'>
<div className='w-full gap-8 h-1/2 flex'>

      <div className="w-full h-52 max-w-md px-8 py-4 mt-16 bg-gray-200 rounded-lg shadow-xl dark:bg-gray-800">
...
<div className='w-full gap-8 h-2/3 flex'>
